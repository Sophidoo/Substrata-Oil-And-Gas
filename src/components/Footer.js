    ...
    <>
      <footer>
        <ul className="companyInfo">
          ...
          <p>
            Created by a group of experienced industry Professionals to ensure
            quality services are available at cost effective and efficient rates
            to operators in the Oil and Gas industry in Nigeria.
          </p>
        </ul>
        ...
        <div className="contact">
          ...
          <ul className="footer_menu">
            ...
            <p>
              <AiTwotoneMail /> info@substrataoilandgas.com
            </p>
            <p>
              <ImLocation /> Plot 59 Professor Okujagu street, off Trans Amadi
              road, Port Harcourt.
            </p>
